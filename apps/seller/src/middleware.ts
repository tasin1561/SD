 ...
 *
 * Seller needs Spaces for direct-to-storage image upload.
 *
...
const build = createCspMiddleware({
  // Catalog image upload PUTs straight to a presigned Spaces URL, and the
  // uploaded images are then displayed from there.
