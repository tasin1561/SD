...
const WALLET_SETTINGS = [
  ...
  ['wallet.withdrawal_max_per_day', 'Withdrawals per day', 'How OFTEN, never how much.'],
  ['wallet.withdrawal_max_per_month', 'Withdrawals per month', 'Rolling 30 days.'],
  [
    'wallet.withdrawal_sla_hours',
    'Withdrawal SLA (hours)',
    'What we promise once a request is raised.',
  ],
  ['wallet.auto_withdraw_enabled', 'Auto withdrawal', 'Raises a request for them on a schedule.'],
  [
