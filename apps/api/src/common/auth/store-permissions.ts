...
export const STORE_PERMISSION_GROUPS = ['Store', 'Team', 'Catalogue', 'Terms', 'Money'] as const;
...
export const DEFAULT_STORE_ROLES: ReadonlyArray<{
  ...
  },
  {
    ...
    name: 'Finance',
    description:
      'The money side: the wallet, top-ups and withdrawals. Sees the store, its team, its catalogue and its terms.',
    permissions: [
      'store.profile.view',
      'team.view',
      'catalogue.view',
