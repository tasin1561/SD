 ...
 *
 * It shipped exactly that way in apps/seller, and again here: the
 * courier on/off switch, both charges-backfill buttons and the admin
 * return request all pre-stringified, and not one of them worked.
 *
